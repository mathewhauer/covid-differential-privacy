...
kable(table, booktabs=T, format='latex', caption = "Summary error percentages by Age- and Race-group. Pop refers to populations less than or equal to a given value.",
